...
class GameClass{
    ...
    initBasicSetup(){
        monsters[0].changeField(this, 1, 1);
        monsters[1].changeField(this, 1, 26);
        monsters[2].changeField(this, 25, 1);
        monsters[3].changeField(this, 25, 26);

        pacman.changeField( this, 12, 13);
    }
...
class Pacman extends Thing{
    ...
    hitWithPowerPellet(game){
        if(this.field.powerpellet != null){
            ...
            this.field.powerpellet.data.style.visibility = "hidden";
    ...
    hitWithPellet(game) {
        if(this.field.pellet != null){
            ...
            this.field.pellet.data.style.visibility = "hidden";
        ...
        for(let i = 0; i < monsters.length; i++){
            if(monsters[i].field.x === this.field.x &&  monsters[i].field.y === this.field.y ){
                if(monsters[i].state === 'normal'){
                    ...
                    monsters[i].data.style.visibility = "hidden";
                    monsters[i].setPic('');
                    game.updateScore();
                    monsters.splice(i, 1);
                }
...
class Monster extends Thing{
    ...
    setPic(direction){
        if(this.state === 'normal') {
            ...
            this.data.style.backgroundColor = "orange";
            ...
            if(pacman.lives > 0 && game.pelletCount > 0) {
                switch (e.key) {
                    ...
                    case 'c':
                        ...
                        monsters[monsters.length-1].data.style.visibility = "hidden";
                        monsters.pop();
                        break;
                    case ' ':
                        if(colorRoute)
